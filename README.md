...
- 響應式版面：支援電腦、平板及手機
- 桌面單一視窗模式：首頁、輪盤、遊戲及題庫管理毋須上下或左右捲動
...
- 桌面闊度 981px 或以上會自動進入單一視窗版面。
- 已在 1024×768、1280×720 及 1366×768 尺寸檢查，主要頁面沒有水平或垂直捲動。
...
此網站使用 hash route（例如 `#wheel`、`#quiz`、`#tv`），因此在靜態部署環境毋須額外設定路由 rewrite。
